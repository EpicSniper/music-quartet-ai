...
def main():
    preprocess(const.MIDI_DATASET_DIRECTORY, const.TRAIN_DATASET_DIRECTORY)
    create_dataset_files(const.TRAIN_DATASET_DIRECTORY + "/" + const.NAME_DIR_SUFFIX, const.SINGLE_FILE_DATASET, const.SEQUENCE_LENGTH)
